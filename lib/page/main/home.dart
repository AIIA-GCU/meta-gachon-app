                            ...
                            children: [
                              ClipRRect(
                                ...
                                child: Image.asset(
                                  ImgPath.home_img3,
                                  width:
                                      flexibleSize(context, Size.fromWidth(149))
                                          .width,
                                  height:
                                      flexibleSize(context, Size.fromWidth(149))
                                          .width,
                                ...
                                child: InkWell(
                                  ...
                                  customBorder: RoundedRectangleBorder(
                                      borderRadius: BorderRadius.circular(
                                          flexibleSize(
                                                  context, Size.fromHeight(8))
                                              .height)),
                                  child: Ink(
                                    width: flexibleSize(
                                            context, Size.fromWidth(77))
                                        .width,
                                    decoration: BoxDecoration(
                  ...
                  Container(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          Container(
                              height:
                                  flexibleSize(context, Size.fromHeight(140))
                                      .height,
                                  ...
                                  builder: (context, constrains) =>
                                      Stack(children: [
                                        ...
                                        Positioned(
                                          top: 0,
                                          left: flexibleSize(
                                                  context, Size.fromWidth(128))
                                              .width,
                                          child: Text(
                                            "현재 나의 등급은?",
                                            style: KR.label2.copyWith(
                                                color: MGcolor.base1,
                                                fontSize: flexibleSize(context,
                                                        Size.fromHeight(16))
                                                    .height),
                                          ),
                                        ),
