  ...
  Widget build(BuildContext context) {
    return Dialog(
        ...
        child: Container(
          height: 156,
          padding:
              EdgeInsets.fromLTRB(ratio.width * 12, 40, ratio.width * 12, 12),
...
class ReservationPopup extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (item.service == ServiceType.computer) {
      time1 = Text(item.startToDate2(),
          style: KR.parag2.copyWith(color: MGColor.base3));
      time2 = Text('~ ${item.endToDate2()}',
          style: KR.parag2.copyWith(color: MGColor.base3));
    } else {
      time1 = Text(item.startToDate2(),
          style: KR.parag2.copyWith(color: MGColor.base3));
      time2 = Text(item.toDuration(),
          style: KR.parag2.copyWith(color: MGColor.base3));
    }
    ...
    if (myInfo.match(item.leaderInfo)) {
      switch (status) {
        case 0:
          button = Text("사용 전날은 수정 및 취소가 불가합니다.",
          ...
          button = ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                  ...
                  shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(10))),
              child:
                  Text("인증하기", style: KR.parag1.copyWith(color: Colors.white)));
          break;
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Container(
            ...
            decoration: ShapeDecoration(
                image: const DecorationImage(
                    fit: BoxFit.fitWidth, image: AssetImage(ImgPath.home4)),
                shape: RoundedRectangleBorder(
          ...
          SizedBox(
              ...
              child: Text('나중에 바꾸기',
                  textAlign: TextAlign.center,
                  style: KR.label2
                      .copyWith(color: MGColor.base3.withOpacity(0.6)))),
  ...
  Future<void> _edit(BuildContext context) async {
    ...
    if (temp == null || temp.isEmpty) {
      ...
      Navigator.of(context).push(MaterialPageRoute(
          builder: (_) =>
              ReservePage(item.service, availableRoom: temp, reserve: item)));
    }
  }
    ...
    return Dialog(
      ...
      child: Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            child: Container(
              ...
              decoration: ShapeDecoration(
                  image: DecorationImage(
                      fit: BoxFit.fitWidth, image: MemoryImage(item.photo)),
                  shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(8))),
            ),
          ),
          ...
          Container(
              constraints:
                  BoxConstraints(minWidth: ratio.width * 294, minHeight: 60),
    ...
    return Dialog(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              image: DecorationImage(
                  fit: BoxFit.fitHeight, image: myInfo.ratingImg),
